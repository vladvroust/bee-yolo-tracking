...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 23 02:01:13 2018
...
def write_xml(folder, img, objects, tl, br, savedir):
    ...
    save_path = os.path.join(savedir, img.name+'.xml')
...
if __name__ == '__main__':
    ...
    folder = 'bees'
    img = [im for im in os.scandir('bees') if '000001' in im.name][0]
    objects = ['bee']
    tl = [(10, 10)]
    br = [(100, 100)]
    savedir = 'bees_annotations'
